    ...
    <div class="">
      ...
      <div class="container row table-responsive">
          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              @foreach ($disability_records as $discapacidad)
                ...
                @if ($discapacidad->manos_grado == '1' || $discapacidad->pies_grado == '1' || $discapacidad->ojos_grado == '1' )
                  <tr class="g-1">
                    <td>1</td>
                    <td>
        ...
        <div class="text-center mt-4">
                <button type="submit" class="btn btn-success btn-lg">Actualizar Datos Discapacidades </button>
            </div>
      </form>
